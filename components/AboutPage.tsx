...
const AboutPage: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto animate-fade-in bg-white dark:bg-dark-light p-8 rounded-2xl shadow-lg">
      <h1 className="text-4xl font-extrabold text-dark dark:text-light mb-4 text-center">About MahaYatri</h1>
      ...
      <div className="space-y-8 text-gray-700 dark:text-gray-300 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-bold text-primary mb-3">What We Do</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-bold text-primary mb-3">Our Technology</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-bold text-primary mb-3">Meet the (Mock) Team</h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
            ...
            <div className="p-4">
              ...
              <h3 className="font-bold">Rohan Patil</h3>
