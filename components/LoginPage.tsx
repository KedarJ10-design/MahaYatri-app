...
const LoginPage: React.FC<LoginPageProps> = ({ onLogin }) => {
  return (
    <div className="flex items-center justify-center min-h-screen bg-cover bg-center" style={{ backgroundImage: "url('https://picsum.photos/seed/maharashtra/1920/1080')" }}>
      ...
      <div className="relative z-10 bg-white bg-opacity-90 backdrop-blur-sm p-12 rounded-2xl shadow-2xl text-center max-w-lg w-full mx-4">
        ...
        <h1 className="text-4xl font-bold text-dark mb-3">Welcome to MahaYatri</h1>
        <p className="text-gray-600 mb-10">Your adventure in Maharashtra awaits. Please sign in to continue.</p>
        
        <div className="space-y-4">
          <Button onClick={onLogin} className="w-full flex items-center justify-center space-x-2">
          ...
          <Button onClick={onLogin} variant="secondary" className="w-full flex items-center justify-center space-x-2">
